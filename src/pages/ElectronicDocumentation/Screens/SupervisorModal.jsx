...
import { 
  X, CheckCircle2, XCircle, FileText, UserCheck, 
...
export default function SupervisorModal({ isOpen, onClose }) {
  const { user } = useAuth();
  ...
  return (
    <>
      <AnimatePresence>
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 font-tajawal" dir="rtl">
          
          {/* خلفية ضبابية (Backdrop) */}
          <motion.div 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
            exit={{ opacity: 0 }} 
          ...
          {/* الحاوية الرئيسية (نفس هيكلة RegistryModal تماماً لتفادي تداخل الـ z-index) */}
          <motion.div 
          ...
          >
            ...
            {/* ── Header ── */}
            <div className="px-8 py-6 border-b border-slate-200 flex justify-between items-center bg-slate-50/50 shrink-0 z-10">
            ...
            <div className="flex-1 flex overflow-hidden">
              ...
              <div className="w-full lg:w-[380px] bg-slate-50/30 border-l border-slate-200 flex flex-col shrink-0">
                  ...
                  {isLoading ? (
                    ...
                    pendingDocs.map(doc => (
                      <button
                        ...
                        className={`w-full text-right p-4 rounded-2xl border transition-all ${selectedDoc?.id === doc.id ? 'bg-purple-50 border-purple-300 shadow-md ring-1 ring-purple-200' : 'bg-white border-slate-200 hover:border-purple-200 hover:bg-slate-50 shadow-sm'}`}
                      >
              ...
              <div className="flex-1 bg-white flex flex-col relative overflow-y-auto custom-scrollbar">
                {!selectedDoc ? (
                  <div className="flex-1 flex flex-col items-center justify-center text-slate-400">
                    <div className="w-24 h-24 mb-4 rounded-full bg-slate-50 flex items-center justify-center border-4 border-white shadow-sm">
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 p-8 flex flex-col gap-8 max-w-4xl mx-auto w-full">
                       ...
                       <div className="flex justify-between items-start">
                         ...
                         <button 
                           ...
                           className="flex items-center gap-2 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white px-5 py-3 rounded-xl font-black text-sm transition-all shadow-sm border border-blue-100"
                         >
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                           ...
                           <div className="space-y-3 text-xs font-bold">
                              <div className="flex justify-between"><span className="text-slate-500">نوع المستند:</span> <span className="text-slate-800">{selectedDoc.type}</span></div>
                         ...
                         <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                           ...
                           <div className="space-y-3 text-xs font-bold">
                              <div className="flex justify-between"><span className="text-slate-500">التحقق العام:</span> 
                                <span className={selectedDoc.isVerifiable ? "text-emerald-600" : "text-rose-600"}>{selectedDoc.isVerifiable ? "مسموح للعامة ✅" : "محظور ❌"}</span>
                              </div>
                       ...
                       <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                         ...
                         <div className="flex items-center gap-8 px-4">
                            <div className="flex flex-col items-center">
                               <div className="w-8 h-8 rounded-full bg-slate-300 text-white flex items-center justify-center mb-2"><CheckCircle2 className="w-4 h-4" /></div>
                            ...
                            <div className="flex-1 h-1 bg-slate-200 rounded-full mb-6"></div>
                            <div className="flex flex-col items-center">
                    ...
                    <div className="p-6 bg-white border-t border-slate-200 shrink-0 sticky bottom-0">
                        ...
                        {showRejectInput ? (
                          ...
                          <div className="flex gap-4">
                            ...
                            <button 
                              ...
                              disabled={isProcessing}
                              className="flex items-center justify-center gap-2 bg-white border-2 border-rose-200 text-rose-600 text-sm font-black px-8 py-4 rounded-2xl hover:bg-rose-50 hover:border-rose-300 transition-all disabled:opacity-50 active:scale-[0.98]"
                            >
      ...
      {/* 💡 استدعاء شاشة المعاينة المستقلة (FileViewerModal) تظهر فوق كل شيء */}
      {viewingFile && (
        <FileViewerModal
          file={viewingFile}
