...
import {
  ...
  Step3Items,
  Step4Tax,
  Step5Payments, // أضفنا استيراد خطوة الدفعات
  Step6Attachments,
  Step7Terms,
  Step8Review,
...
const CreateQuotationWizard = ({ onComplete }) => {
  ...
  // ==========================================
  // تجميع الـ Props لتمريرها بأسلوب نظيف
  // ==========================================
  const stepProps = {
    // Step 0
    selectedClient,
  ...
  const previewData = {
    ...
    missingDocs,
    showMissingDocs,
    paymentsList, // التعديل الذي قمنا به لضمان ظهور الدفعات في المعاينة
  };
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 font-sans" dir="rtl">
      <div className="flex-1 overflow-hidden p-4 md:p-5 flex gap-6">
        ...
        <div className="w-[50%] flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="flex justify-between items-center p-4 border-t border-slate-200 bg-white shrink-0">
            <button
              ...
              className="px-5 py-2.5 bg-slate-100 text-slate-500 rounded-lg text-xs font-bold flex items-center gap-1.5 hover:bg-slate-200 disabled:opacity-40 transition-colors"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 bg-blue-600 text-white rounded-lg text-xs font-bold flex items-center gap-1.5 hover:bg-blue-700 disabled:opacity-40 transition-colors shadow-sm"
            >
        ...
        {/* الجانب الأيسر (المعاينة الحية للورقة A4) 40% */}
