...
export const Step4Tax = ({ props }) => {
  ...
  return (
    <div className="animate-in fade-in duration-300 h-full flex flex-col text-[#123f59]">
      <div className="p-3 bg-white rounded-xl border border-[#d8b46a]/25 shadow-[0_8px_22px_rgba(18,63,89,0.06)]">
            ...
            <div className="flex gap-1.5">
              {[0, 50, 100].map((val) => (
                <button
                  ...
                  className={`flex-1 p-1.5 rounded-xl text-[11px] font-bold border transition-colors ${
        ...
        <div className="p-3 bg-gradient-to-br from-[#eef7f6] via-[#fbf8f1] to-white rounded-xl">
          <div className="flex min-w-0 justify-between text-xs mb-1.5 text-[#64748b]">
