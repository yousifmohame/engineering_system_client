    ...
    <div className="flex flex-col h-full gap-1 p-1 min-h-0 animate-in fade-in">
      ...
      <div className="flex-1 bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-0">
        ...
        <div className="min-h-0 flex-1 overflow-auto custom-scrollbar-slim">
          <table className="w-full min-w-[920px] border-separate border-spacing-0 text-right text-[11px]">
            <thead className="sticky top-0 z-10 border-b border-[#d8b46a]/30 bg-gradient-to-l from-[#06111d] via-[#123f59] to-[#0e7490] text-white">
              <tr>
                <th className="border-l border-white/10 px-2 py-1.5 text-[10px] font-black text-white w-9 text-center">
                  الكود
                </th>
                <th className="border-l border-white/10 px-2 py-1.5 text-[10px] font-black text-white">
                  الموظف / الدخول
                </th>
                <th className="border-l border-white/10 px-2 py-1.5 text-[10px] font-black text-white hidden sm:table-cell">
                  المسمى (داخلي/قوى)
                </th>
                <th className="border-l border-white/10 px-2 py-1.5 text-[10px] font-black text-white hidden md:table-cell">
                  الأدوار والصلاحيات
                </th>
                <th className="border-l border-white/10 px-2 py-1.5 text-[10px] font-black text-white text-center w-14">
                  الحالة
                </th>
                <th className="px-2 py-2 text-[10px] font-black text-white text-center w-14">
                  إجراءات
                </th>
              </tr>
            </thead>
