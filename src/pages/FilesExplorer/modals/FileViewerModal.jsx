      ...
      <div className="flex items-center justify-between px-6 py-4 bg-gray-900 text-white shrink-0 shadow-md">
        ...
        <div className="flex items-center gap-3">
          ...
          {isPdf && (
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm font-bold"
            >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-sm font-bold"
          >
            <Download size={16} /> تحميل
          </button>
          <button
            onClick={onClose}
            className="p-2 ml-2 bg-red-500/20 text-red-400 hover:bg-red-500 hover:text-white rounded-lg"
          >
            <X size={24} />
          </button>
        </div>
