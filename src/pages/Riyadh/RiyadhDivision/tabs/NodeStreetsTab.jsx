    ...
    <div className="space-y-3 animate-in fade-in duration-300">
      ...
      <div className="flex items-center justify-between p-3 bg-[#fbf8f1] rounded-xl border border-[#e8ddc8]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-[#94a3b8] bg-white px-2 py-1 rounded-md font-bold border border-[#e8ddc8]">
        ...
        <button
          ...
          className="px-3 py-1.5 text-[11px] bg-[#0e7490] text-white rounded-lg hover:bg-[#15536f] flex items-center gap-1.5 font-bold shadow-[0_6px_14px_rgba(18,63,89,0.04)] transition-colors"
        >
          <IconWithText icon={Plus} text="إضافة تنظيم لشارع" iconClassName="w-3.5 h-3.5" /></button>
      </div>
            ...
            <tbody className="divide-y divide-stone-100">
              {streets?.length > 0 ? (
                streets.map((st, idx) => (
                  ...
                  >
                    <td className="py-2.5 px-3 text-[#94a3b8] font-mono text-center">
                      {idx + 1}
                    </td>
                    ...
                    <td className="py-2.5 px-3 text-center">
                      {st.hasSpecialRegulation ? (
                        <span className="px-2 py-1 bg-[#d8b46a]/25 text-[#15536f] text-[9px] rounded font-black border border-[#d8b46a]/35 flex items-center gap-1 w-fit mx-auto">
                    ...
                    <td className="py-2.5 px-3 max-w-[200px]">
                      <div className="flex items-center gap-2">
                        <p className="truncate text-[#64748b] font-medium italic">
                        ...
                        {st.regulationDetails?.fileUrl && (
                          <a
                            ...
                            target="_blank"
                            className="p-1 bg-[#fbf8f1] text-[#94a3b8] rounded hover:text-[#0e7490] transition-colors"
                    ...
                    <td className="py-2.5 px-3 text-center">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="p-1.5 rounded-md text-[#94a3b8] hover:text-[#0e7490] hover:bg-[#eef7f6] transition-colors"
                        >
                          <IconWithText icon={Edit} text="تعديل" iconClassName="w-3.5 h-3.5" /></button>
                        <button
                        ...
                        >
                          <IconWithText icon={Trash2} text="حذف" iconClassName="w-3.5 h-3.5" /></button>
                      </div>
                    </td>
                  </tr>
                ))
                ...
                <tr>
                  <td
                    colSpan="6"
                    className="text-center py-4 text-[#94a3b8] font-bold bg-[#fbf8f1]/50"
                  >
