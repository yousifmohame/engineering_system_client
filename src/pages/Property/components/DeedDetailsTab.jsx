...
const DocumentViewer = ({ doc, onClose }) => {
  ...
  // نحدد مصدر الملف (سواء كان Base64 جديد أو رابط من السيرفر)
      ...
      <div className="flex-1 overflow-auto flex items-center justify-center p-4 custom-scrollbar relative">
        {fileSource ? (
          ...
          <div className="text-slate-500 flex flex-col items-center">
            ...
            <p>لا توجد معاينة متاحة لهذه الوثيقة (قد تكون غير مرفوعة)</p>
          </div>
        )}
      </div>
    </div>
          ...
          <div className="animate-in fade-in h-full flex flex-col">
            ...
            {localData.documents.length > 0 ? (
              <div className="flex-1 min-h-0 relative border border-slate-200 rounded-xl overflow-hidden bg-white shadow-sm flex flex-col">
                  ...
                  <table className="w-full text-right text-xs border-collapse">
                    <thead className="bg-slate-50 sticky top-0 z-10 shadow-sm border-b-2 border-slate-200">
                      <tr>
                        ...
                        <th className="p-3 font-bold w-16 text-slate-600">
                          معاينة
                        </th>
                ...
                {/* شريط سفلي صغير يعرض عدد العناصر (اختياري لزيادة الاحترافية) */}
