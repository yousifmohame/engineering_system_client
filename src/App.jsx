...
import QuoteVerificationPage from "./pages/verify/QuoteVerificationPage";
// --- Icons & Context ---
...
import DocumentVerificationScreen from "./pages/v/DocumentVerificationScreen";
...
const AppContent = () => {
  ...
  const { activeScreenId, fetchSidebarConfig } = useAppStore();
      ...
      <div className="flex-1 flex flex-col mr-[300px] h-screen overflow-hidden bg-[#f3f4f6]">
        ...
        <main className="flex-1 relative overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-auto p-0 pb-8 scroll-smooth relative h-full">
            {/* --- الشاشات المبرمجة --- */}
            <div
              className={activeScreenId === "01" ? "block h-full" : "hidden"}
            >
              <Dashboard />
            </div>
            <div
            ...
            <div
              className={activeScreenId === "40" ? "block h-full" : "hidden"}
            >
              <Screen40_Sectors />
            </div>
            <div
              className={activeScreenId === "41" ? "block h-full" : "hidden"}
            >
              <Screen41_Districts />
            </div>
            <div
              className={activeScreenId === "222" ? "block h-full" : "hidden"}
            >
              <ContractsScreen />
            </div>
            <div
              className={activeScreenId === "30" ? "block h-full" : "hidden"}
            >
              <BrokersPage />
            </div>
            <div
              className={activeScreenId === "31" ? "block h-full" : "hidden"}
            >
              <Screen860IntermediaryOffices />
            </div>
            <div
              className={activeScreenId === "32" ? "block h-full" : "hidden"}
            >
              <PartnersPage />
            </div>
            <div
            ...
            <div
              className={activeScreenId === "0010" ? "block h-full" : "hidden"}
            >
              <OurOfficePermits />
            </div>
            <div
              className={activeScreenId === "10" ? "block h-full" : "hidden"}
            >
            ...
            <div
              className={activeScreenId === "98" ? "block h-full" : "hidden"}
            >
              <EmailNotificationsCenter />
            </div>
            <div
              className={activeScreenId === "99" ? "block h-full" : "hidden"}
            >
              <InboxCenter />
            </div>
            <div
              className={activeScreenId === "100" ? "block h-full" : "hidden"}
            >
              <FileRequest />
            </div>
            <div
              className={activeScreenId === "101" ? "block h-full" : "hidden"}
            >
              <EmailSettingsScreen />
            </div>
            ...
            >
              <ContractsManagementScreen />
            </div>
            <div
              className={activeScreenId === "030" ? "block h-full" : "hidden"}
            >
              <OfficeNotepadScreen />
            </div>
            <div
            ...
            <div
              className={activeScreenId === "52" ? "block h-full" : "hidden"}
            >
              <AiDashboard />
            </div>
            <div
              className={activeScreenId === "12" ? "block h-full" : "hidden"}
            >
              <HubScreen />
            </div>
            <div
              className={activeScreenId === "04" ? "block h-full" : "hidden"}
            >
