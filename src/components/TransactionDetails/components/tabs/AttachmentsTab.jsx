...
export const AttachmentsTab = ({ tx, currentUser, backendUrl }) => {
  ...
  return (
    <div
      className="
        relative flex h-full min-h-[500px] flex-col overflow-hidden
        bg-gradient-to-br from-[#eef7f6] via-[#fbf8f1] to-white
        font-[Tajawal] animate-in fade-in
      "
      dir="rtl"
      onDragOver={(e) => {
        e.preventDefault();
    ...
    >
      ...
      {isDragging && (
        <div
          className="
            ...
            rounded-[28px] border-2 border-dashed border-[#c5983c]
            bg-[#123f59]/75 backdrop-blur-sm
          "
        >
          <div className="text-center text-white">
            <UploadCloud className="mx-auto mb-3 h-14 w-14 text-[#e2bf74]" />
            <p className="text-lg font-black">أفلت الملف هنا للرفع</p>
            <p className="mt-1 text-xs font-bold text-white/70">
              سيتم رفع الملف داخل المجلد الحالي
            </p>
          </div>
        </div>
      )}
      ...
      <div
        className="
          relative shrink-0 overflow-hidden rounded-t-[28px]
          border border-[#d8b46a]/30
          bg-gradient-to-l from-[#06111d] via-[#123f59] to-[#0e7490]
          p-4 text-white
          shadow-[0_18px_45px_rgba(18,63,89,0.18)]
        "
      >
            ...
            <div className="mb-3 flex items-center gap-3">
              ...
              <div className="min-w-0">
                <h3 className="truncate text-base font-black md:text-lg">
                  مرفقات وملفات المعاملة
                </h3>

                <p className="mt-0.5 text-xs font-bold text-white/65">
                  إدارة الملفات، المجلدات، المعاينة، والتحميل.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <label
              className="
                ...
                bg-[#e2bf74] px-5 text-xs font-black text-[#123f59]
                shadow-[0_12px_30px_rgba(226,191,116,0.25)]
      ...
      <div
        className="
          ...
          rounded-b-[28px] border-x border-b border-[#d8b46a]/30
          bg-white/88 p-4
      ...
      >
        ...
        <div
          className="
            ...
            border border-[#d8b46a]/25 bg-gradient-to-l from-[#fbf8f1] via-white to-[#eef7f6]
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black text-[#123f59]">
                {currentFolderId ? currentFolderName : "الملفات الأساسية"}
              </p>
...
const FolderCard = ({ folder, onOpen, onDelete }) => (
  ...
  >
    ...
    <button
      ...
      className="
        absolute left-2 top-2 grid h-8 w-8 place-items-center
        rounded-xl bg-[#123f59] text-[#e2bf74] opacity-0
        transition-all hover:bg-[#0f3448]
        group-hover:opacity-100
      "
      type="button"
      title="فتح المجلد"
    ...
    <div
      className="
        mb-3 mt-2 grid h-20 w-20 place-items-center rounded-[28px]
...
const FileCard = ({
  ...
  >
    ...
    <div className="relative flex flex-1 flex-col items-center justify-center py-5">
      {fileUrl?.match(/\.(jpeg|jpg|gif|png|webp)$/i) && fullUrl ? (
        <div
          className="
...
const EmptyState = () => (
  <div
    className="
      ...
      justify-center rounded-[28px] border border-dashed
...
const PreviewModal = ({ previewFileUrl, previewFileName, onClose }) => (
  <div
    className="
    ...
    >
      ...
      >
        <div className="flex min-w-0 items-center gap-3 overflow-hidden">
          ...
          <h3 className="truncate text-sm font-black" title={previewFileName}>
            {previewFileName}
          </h3>
        </div>
